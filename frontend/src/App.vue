...
<template>
  <v-app id="inspire" dark="">
    <v-navigation-drawer
      v-if="pageStruct != null"
      v-model="drawer"
      app
      clipped
    >
      <v-list dense>
        <v-list-item v-if="parentPageID != null" v-on:click="ws_send_wsEvent_pageChange(parentPageID)">
          <v-list-item-action>
        ...
        <v-list-item v-for="childPage in childPages" v-bind:key="'navButtonTo:' + childPage.id" v-on:click="ws_send_wsEvent_pageChange(childPage.id)">
          <v-list-item-action>
