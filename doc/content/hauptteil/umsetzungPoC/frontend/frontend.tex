...
Das Textfeld hat die drei verschiedene Darstellungen, welche in \refFig{fig:frontend:poc:textFeld} dargestellt sind.
\begin{figure}[ht]
  \centering
...
In \refFig{fig:frontend:poc:textFeld:nachAenderung} sieht man den in \refFig{fig:frontend:poc:textFeld:focus} eingegeben neuen Wert \eigenNameNorm{neuer Text} in der gleichen Darstellung wie in \refFig{fig:frontend:poc:textFeld:noFocus} dargestellt.
