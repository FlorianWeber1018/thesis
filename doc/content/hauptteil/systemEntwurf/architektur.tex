...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{content/hauptteil/systemEntwurf/res/KlassendiagramVuexState.pdf}
  \caption[Datenzugriff innerhalb des Frontends]{Schema des Zugriffs auf die Datenstruktur des Frontends}
  \label{fig:dataFlowFrontend}
\end{figure}
Die Struktur ist in Abbildung \ref{} dargestellt

Sie ist eine Kopie einer einzelnen Page als \ac{json}
