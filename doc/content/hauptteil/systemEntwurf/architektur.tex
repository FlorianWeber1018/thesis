...
die es dem Nutzer ermöglich sich durch individuelle Zugansdaten (Benutzername, Passwort) zu Authentifizieren.%authentifiziert->layout fig
...
%Der Weg, Daten zu verändern ist nun, mit einer Nachricht an das Backend eine Datenänderung ''anzufragen''.
